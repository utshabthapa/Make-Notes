    ...
    const fetchData = async () => {
      try {
        const [noteRes, categoriesRes] = await Promise.all([
          axios.get(`${API_BASE_URL}/notes/${id}`, { withCredentials: true }),
        ...
        if (note) {
          setFormData({
            ...
            categories: note.categories ? note.categories.map((c) => c.id) : [],
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-lg font-medium bg-transparent"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none bg-transparent"
